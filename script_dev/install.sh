...
if [ "$(uname)" == "Darwin" ] ; then
  ...
  mkdir xii
  cd xii
  wget -c https://github.com/xiiapp/xii/raw/main/release_dev/xii_mac.zip  -O xii.zip
  unzip xii.zip -d ./
  mv -f ~/xii/mac/* ./
  rm -rf ~/xii/release
  rm -f ~/xii/xii.zip
  ...
  mkdir xii
  cd xii
  wget -c https://github.com/xiiapp/xii/raw/main/release_dev/xii_linux.zip  -O xii.zip
  unzip xii.zip -d ./
  mv -f /home/xii/linux/* ./
